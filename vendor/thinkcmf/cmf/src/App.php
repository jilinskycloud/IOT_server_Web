...
class App extends Container
{
                ...
                if ('' == $module) {
                    ...
                    if ($this->namespace == 'app' || $this->namespace == 'api') {
                        foreach ($mainConfigNames as $configName) {
                            $this->config->load(CMF_ROOT . $this->namespace . $configName . $this->configExt, $configName);
                        }

                        $tagsFile = CMF_ROOT . $this->namespace . 'tags.php';
                        if (is_file($tagsFile)) {
    ...
    public function routeInit()
    {
        ...
        if ($this->namespace == 'api') {
            $rules = include CMF_ROOT . 'api/route.php';
            if (is_array($rules)) {
                $this->route->import($rules);
            }
        }
